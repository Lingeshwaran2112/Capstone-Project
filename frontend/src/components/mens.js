...
function Mens(props){
    ...
    const { setWomenslink , setMensLink , setSunglassesLink ,setAllProductSort} =React.useContext(Appcontext)
    const {setMobilesLink , setCameraLink ,setAllShopLink,setMensWearState} = React.useContext(Appcontext)
