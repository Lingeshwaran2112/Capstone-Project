        ...
        <div className="container-fluid">
            <div className="row" >
                <div className="col-lg-4 rows12">
                    ...
                    <img src="./images/homewomens.jpg" alt="womens" className="twerk" />
                ...
                <div className="col-lg-4 rows12"  >
                    <Link to="/mens">
                    <div  className="homeImg">
                    <img src="./images/homemens.jpg" alt="mens" className="twerk"/>
                    <div className="titleHome">
                ...
                <div className="col-lg-4 rows12" >
                    <Link to="/sunglasses">
                    <div  className="homeImg">
                    <img src="./images/homesunglasses.jpg" alt="sunglasses" className="twerk"/>
                    <div className="titleHome">
