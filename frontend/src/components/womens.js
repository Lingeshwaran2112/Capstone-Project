...
function Womens(props){
    ...
    const { setWomenslink , setMensLink , setSunglassesLink } =React.useContext(Appcontext)
    const {setMobilesLink , setCameraLink ,setItemDetails,setAllShopLink , setMensWearState} = React.useContext(Appcontext)
