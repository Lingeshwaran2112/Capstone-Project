...
async function connection (){
    ...
    app.get("/womens" , sortingServices.womensSort)

    app.get("/mens" , sortingServices.mensSort)

    app.get("/sunglasses" , sortingServices.sunglassesSort)

    app.get("/mobiles" , sortingServices.mobilesSort)

    app.get("/camera" , sortingServices.cameraSort)
